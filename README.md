...
- Open Settings to choose the built-in pattern and edge behavior
- Switch between dark (green on black) and light (black on white) themes
- In landscape viewports the whole interface always fits the screen — no scrolling; portrait viewports scroll
