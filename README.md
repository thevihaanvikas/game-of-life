...
- Open Settings to choose responsive or fixed grid sizes, built-in patterns, and edge behavior
- Switch between dark (green on black), light, and high-contrast themes
